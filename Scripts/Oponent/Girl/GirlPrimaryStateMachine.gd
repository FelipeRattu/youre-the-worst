...
var icon = preload("res://Sprites/Oponents/Girl/GirlIcon.png")
...
func _enter_state(new_state, old_state):
	match new_state:
		states.Idle:
			primaryAnimationPlayer.play("GirlIdle")
		states.Run:
			parent.canCrouch = true
			primaryAnimationPlayer.play("GirlRun")
		states.Slide:
			parent.canCrouch = true
			primaryAnimationPlayer.play("GirlSlide")
		states.Jump:
			parent.weight = parent.weightUp
			parent.jump()
			primaryAnimationPlayer.play("GirlJump")
		states.Fall:
			parent.weight = parent.weightDown
			primaryAnimationPlayer.play("GirlFall")
		states.Finish:
			parent.get_node("Roll").stop()
			parent.canCrouch = false
			match GameManager.causeOfGameOver:
				"Win": primaryAnimationPlayer.play("GirlLose")
				"Lose": primaryAnimationPlayer.play("GirlWin")
